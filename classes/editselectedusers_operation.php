 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_selfqrcode_editselectedusers_operation extends enrol_bulk_enrolment_operation {
    ...
    public function get_title() {
        return get_string('editselectedusers', 'enrol_selfqrcode');
    }
    ...
    public function process(course_enrolment_manager $manager, array $users, stdClass $properties) {
        ...
        if (!has_capability("enrol/selfqrcode:manage", $manager->get_context())) {
            return false;
        }
    ...
    public function get_form($defaultaction = null, $defaultcustomdata = null) {
        return new enrol_selfqrcode_editselectedusers_form($defaultaction, $defaultcustomdata);
    }
}

...
$string['pluginname'] = 'Self QRCODE enrolment';
...
$string['selfqrcode:config'] = 'Configure self enrol instances';
$string['selfqrcode:holdkey'] = 'Appear as the self enrolment key holder';
$string['selfqrcode:manage'] = 'Manage enrolled users';
$string['selfqrcode:unenrol'] = 'Unenrol users from course';
$string['selfqrcode:unenrolself'] = 'Unenrol self from the course';
